...
You can link:CONTRIBUTING.adoc[contribute] to improve this documentation on
...
[IMPORTANT]
====
Follow the Antora's site https://docs.antora.org/antora/latest/install/install-antora/[prerequisites] for its installation (mainly using nvm, this will install npm)
====
