...
= Defining a Model
:page-tags: manual, tutorial-12
:parent-catalogs: tutorial-base
:page-description: Defining a model in Feel++ applications.
:page-illustration: fa-solid fa-drafting-compass
:page-cards-order: 12
=== Introduction
...
link:../07-quickref/Models/README.adoc[section].
