...
[source,cpp]
----
include::example$mylaplacian.cpp[tag=marker1]
----
...
Using the xref:Solver/backend.adoc[PETSc backend] allows to choose different packages to compute the factorization.
