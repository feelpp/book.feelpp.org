...
We decide to launch the previous code with a stem:[t_{init}=10], stem:[t_{max}=10] and a time step  stem:[\Delta_t=0.1]. It corresponds to 100 time iterations in the BDF loop.
