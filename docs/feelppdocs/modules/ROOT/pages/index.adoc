...
|===
| xref:{feelpp-stable-version}@user:install:index.adoc[Get {feelpp} {feelpp-stable-version}] via Docker(All platforms) or Debian/Ubuntu packages (including WSL).
| xref:{feelpp-devel-version}@user:install:index.adoc[Get {feelpp} {feelpp-devel-version}] via Docker(All platforms) or Debian/Ubuntu packages (including WSL).
|===
...
++++
[#cover-user-link]
xref:{feelpp_user_doc_version}@user:ROOT:index.adoc[{feelpp} User Manual]
++++
...
++++
[#cover-dev-link]
xref:{feelpp_dev_doc_version}@dev:ROOT:index.adoc[{feelpp} Developer Manual]
++++
...
++++
[#cover-data-link]
xref:{feelpp_data_doc_version}@data:ROOT:index.adoc[{feelpp} Data Manual]
++++
