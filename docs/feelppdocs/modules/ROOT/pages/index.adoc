...
:feelpp-stable-version: 0.107
:feelpp-devel-version: 0.108
...
The current development version of {feelpp} is **{feelpp-devel-version}** and the associated documentation may be updated anytime.
