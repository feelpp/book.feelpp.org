...
Using {feelpp} inside <<using/what-is-docker.adoc#what-is-docker,Docker>> is the recommended and fastest way to use {feelpp}.
The <<using/README.adoc#docker,Docker>> chapter is dedicated to Docker and using {feelpp} in Docker.
