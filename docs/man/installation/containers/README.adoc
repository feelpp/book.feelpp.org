...
documentation with respect to your operating system. 
...
For example, via the commandline and using the {feelpp} toolboxes.
We get the image and create a new container.
