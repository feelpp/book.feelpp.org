= Description
:page-tags: manual, data-description
:parent-catalogs: data-manuals-catalog
:page-description: Detailed description of Feel++ data structures and formats.
:page-illustration: fa-solid fa-clipboard-list
:page-cards-order: 2
