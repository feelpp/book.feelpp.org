...
:stem: latexmath
:page-tags: manual,solver-bddc
:page-cards-tag: manual
:parent-catalogs: solver
:page-illustration: fa-solid fa-gears
:page-description: Balancing Domain Decomposition by Constraints (PCBDDC) is a robust domain decomposition technique for solving large linear systems that arise, for example, from finite element discretizations of PDEs.
:page-cards-order: 3
]
