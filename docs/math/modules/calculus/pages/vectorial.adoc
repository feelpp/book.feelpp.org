...
:stem: latexmath
:page-tags: manual,calculus-diff
:page-cards-tag: manual
:parent-catalogs: calculus
:page-description: This page presents key concepts and formulas in vector calculus, particularly those related to vector fields and differential operators.
