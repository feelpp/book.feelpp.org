...
= Eléments finis de Lagrange
:page-tags: manual,fem-lagrange
:page-cards-tag: manual
:parent-catalogs: fem
:page-illustration: fa-solid fa-mesh
:page-description: Lagrange finite elements in 1D, 2D and 3D (triangular, rectangular, tetrahedral, hexahedral, prismatic).
