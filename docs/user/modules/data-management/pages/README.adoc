...
The section <<_description, Describtion>> will details the {feelpp} input
...
This section details the {feelpp} "journal" system. The goal of this
jour system is to retrieve simulation information in a metadata file.

==== Static file (JSON)

{feelpp} have a journal system to aggregates simulation information as metadata.
...
(weak dependency). Each generated journal file represent an entry.
