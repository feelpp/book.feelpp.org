...
[source,cpp]
----
include::{examplesdir}/qs_laplacian.cpp[tag=mesh]
----
...
[source,cpp]
----
include::{examplesdir}/qs_laplacian.cpp[tag=discr]
----
Next we define
...
[source,cpp]
----
include::{examplesdir}/qs_laplacian.cpp[tag=v]
----
...
[source,cpp]
----
include::{examplesdir}/qs_laplacian.cpp[tag=vf]
----
...
[source,cpp]
----
include::{examplesdir}/qs_laplacian.cpp[tag=solve]
----
...
[source,cpp]
----
include::{examplesdir}/qs_laplacian.cpp[tag=ug]
----
...
[source,cpp]
----
include::{examplesdir}/qs_laplacian.cpp[tag=export]
----
...
CAUTION: the test cases are available in Docker in the directory (`/usr/local/share/feelpp/testcases/quickstart/laplacian`).
