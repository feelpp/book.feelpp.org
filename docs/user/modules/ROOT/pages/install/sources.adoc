...
* [x] to understand the xref:install/prerequisites-dev.adoc[{feelpp} programming environment].
* [x] to install the required and suggested compilers, libraries and tools for xref:install/linux.adoc[Linux] or xref:install/mac.adoc[MacOsX] to build {feelpp} for these architectures.
