...
location. Note that from now on, all tools/libraries installed by MacPorts will be installed in `/opt/local/`.
...
[source,bash]
----
$ sudo port install feel++ +clang38+openmpi
----
