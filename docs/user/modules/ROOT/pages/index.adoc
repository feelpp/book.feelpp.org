...
. libraries to to manipulate physics based models and couple them
. a set of mono and multi-physics application readily available :
  ...
  * thermoelectric.
. {pyfeelpptb} which provides an interface to the different physical based models and reproduces the applications in {python}
