...
actor=plotter.add_mesh(mesh, scalars="u", clim=None, cmap="viridis", show_scalar_bar=True, show_edges=True)
actor = plotter.add_orientation_widget(pv.Arrow(), color='r')
plotter.show()
----
