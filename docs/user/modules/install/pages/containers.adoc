...
Apptainer is a container technology initially developed to work with
...
https://github.com/feelpp/feelpp/pkgs/container/feelpp.
...
[source,bash]
----
apptainer shell -B ${HOME}/feel:/feel feelpp-noble.sif
----
