...
xref:user:ROOT:install/index.adoc[Feel++ installation] documentation
(xref:user:ROOT:install/containers.adoc[1.],
xref:user:ROOT:install/sources.adoc[2.] and 
xref:user:ROOT:install/sources.adoc[3.]) before going further.
...
image::shell/singularity/singularity-prompt2.png[align=center]
...
|===
| feelpp-lib/develop_gcc640_openmpi1107
| feelpp-quickstart/develop_gcc640_openmpi1107
| feelpp-toolboxes/develop_gcc640_openmpi1107
|===
...
xref:user:ROOT:install/sources.adoc[install {feelpp} from sources].
