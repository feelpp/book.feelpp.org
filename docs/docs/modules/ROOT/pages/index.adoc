...
:feelpp-stable-version: 0.105
include::{partialsdir}/header-uri.adoc[]
include::{partialsdir}/header-levels.adoc[]

[caption="Documentation Version"]
TIP: The latest released version of {feelpp} is **{feel-stable-version}** and the documentation will be only updated to fix issues. The current development version of {feelpp} is **{feelpp-devel-version}** and the associated documentation may be updated anytime.
