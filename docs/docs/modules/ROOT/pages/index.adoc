...
:feelpp-stable-version: 0.104
:feelpp-devel-version: 0.105
include::{partialsdir}/header-uri.adoc[]
include::{partialsdir}/header-levels.adoc[]

[.lead]
Welcome to {feelpp} documentation! {feelpp} is an Open-Source {cpp} library which allows to solve a large of partial differential equations using Galerkin methods, _e.g_ finite element method, spectral element method,  discontinuous Galerkin methods or reduced basis methods. 


[caption="Documentation Version"]
TIP: The latest released version of {feelpp} is **{feelpp-stable-version}** and the documentation will be only updated to fix issues. The current development version of {feelpp} is **{feelpp-devel-version}** and the associated documentation may be updated anytime.
...
** xref:0.105@cases:ROOT:index.adoc[Cases]
