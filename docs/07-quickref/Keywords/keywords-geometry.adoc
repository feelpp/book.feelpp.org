...
|`P()`|stem:[\overrightarrow{P}]| $$(P_x, P_y, P_z)^T$$|stem:[d \times 1]
...
|`C()`|stem:[\overrightarrow{C}]| $$(C_x, C_y, C_z)^T$$|stem:[d \times 1]
...
|===
|Feel++ Keyword | Math Object | Description | Dimension 
|`N()`|stem:[\overrightarrow{N}]| $$(N_x, N_y, N_z)^T$$|stem:[d \times 1]
