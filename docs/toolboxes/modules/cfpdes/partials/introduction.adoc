...
| stem:[c]      | scalar or matricx    | scalar or matrix
...
++++
\begin{eqnarray*}
u_i = g_i(u_j,x,t,\mu), \quad i=1,\dots,N, \quad j=1,\dots,N(j \neq i) 
\end{eqnarray*}
++++
...
++++
\begin{eqnarray*}
\frac{\partial u_i}{\partial n} = g_i(u_j,\frac{\partial u_j}{\partial x_k},x,t,\mu), \quad i=1,\dots,N, \quad j=1,\dots,N \quad k=1,\dots,d
\end{eqnarray*}
++++
...
The Robin conditions may depend  on the space variable stem:[x], time stem:[t], parameters stem:[\mu] and the unknowns stem:[u_1, \dots, u_N] other than the current one.
...
++++
\begin{eqnarray*}
\frac{\partial u_i}{\partial n} = \eta_i + \zeta_i u_i, \quad i=1,\dots,N
\end{eqnarray*}
++++
