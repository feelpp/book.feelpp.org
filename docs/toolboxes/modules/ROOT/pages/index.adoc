...
|====
a| image::RED_potential+flux-600x300.png[title=xref:hdg:mixedpoisson:index.adoc[HDG Poisson],caption=""] 
a| image::mixedelasticity_testIBC-600x300.png[title=xref:hdg:mixedelasticity:index.adoc[HDG Elasticity],caption=""] 
|====
