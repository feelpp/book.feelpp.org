...
NOTE: If the function solution is written `f={f1,f2}` the field `grad_solution` have to be written like this : `{dxf1,dyf1,dxf2,dyf2}:x:y` (`dxf1` standing for stem:[\partial_x f_1]).
