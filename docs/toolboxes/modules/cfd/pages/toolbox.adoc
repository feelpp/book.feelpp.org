...
| fluid_U_0              | stem:[u_0]                             | evaluate the temperature
| fluid_U_1              | stem:[u_1]                             | evaluate the temperature
| fluid_U_2              | stem:[u_2]                             | evaluate the temperature
| fluid_U_magnitude      | stem:[\sqrt{u \cdot u}]                             | evaluate the temperature
| fluid_curl_U_magnitude | stem:[\nabla \wedge u | evaluate the first component of gradient of temperature
|===
