...
With a larger stem:[\Delta t], a discrepancy is observed, in particular for the drag force. It can also be seen at the same time step, with a higher order stem:[\mathrm{BDF}_n] ( _e.g._ stem:[\mathrm{BDF}_3] ). This suggests that the couple $$\Delta t=0.05$$ and stem:[\mathrm{BDF}_2] isn't enough accurate.
